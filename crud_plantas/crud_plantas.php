...
class CrudPlanta
{
    ...
    public function eliminar($id)
    {
        ...
        $consultaDelete = mysqli_query($this->db->obtenerConexion(), $sqlDelete);
    ...
    public function obtenerPlantaPorId($id)
    {
        ...
        $consultaPlanta = mysqli_query($this->db->obtenerConexion(), $sqlUserId);
    ...
    public function ordenarPorCategoria($numcategoria)
    {
        ...
        foreach($this->listaPlantas as $planta){
            if($planta->getCategoria() == $numcategoria){
        ...
        while ($fila = $consulta->fetch_assoc()) {
            ...
            $listaPlantasCategoria[] = $newPlant;
        }
        return $listaPlantasCategoria;
        */
    }
